...
-- All KPI data is now in mart.kpi_metrics.

-- Insert KPI Categories (DISABLED - dashboard schema removed)
-- INSERT INTO dashboard.kpi_categories (id, name, sort_order) VALUES
    ('finance', 'Финансы', 1),
    ('clients', 'Клиенты', 2),
    ('conversion', 'Конвертация', 3)
-- ON CONFLICT (id) DO NOTHING; -- DISABLED

-- Insert KPI Metrics (DISABLED - dashboard schema removed)
...
--     updated_at = CURRENT_TIMESTAMP; -- DISABLED
