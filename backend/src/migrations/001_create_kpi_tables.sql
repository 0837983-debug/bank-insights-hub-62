-- NOTE: Dashboard schema has been removed. This migration is kept for historical reference only.
-- All data has been migrated to mart schema.
-- CREATE SCHEMA IF NOT EXISTS dashboard; -- DISABLED: dashboard schema removed

-- NOTE: Dashboard tables have been removed. All data migrated to mart schema.
-- KPI Categories table (DISABLED - dashboard schema removed)
...
-- KPI Metrics table (DISABLED - dashboard schema removed)
...
-- Table Data table (DISABLED - dashboard schema removed, data in mart.financial_results and mart.balance)
...
-- Chart Data table (DISABLED - dashboard schema removed, not used)
...
-- Create indexes (DISABLED - dashboard schema removed)
