import { upsertTableData } from "../services/tableDataService.js";
...
async function loadTableData() {
  try {
    ...
    await upsertTableData("income", incomeData);
    console.log("✅ Income data loaded");

    console.log("Loading expenses data...");
    await upsertTableData("expenses", expensesData);
    console.log("✅ Expenses data loaded");

    console.log("✅ All table data loaded successfully!");
  } catch (error) {
