...
export default function FileUpload() {
  ...
  const currentStatus =
    uploadStatus?.status || uploadResponse?.status || (isLoading ? "processing" : undefined);
          ...
          <CardContent className="space-y-6">
            ...
            {currentStatus === "completed" && (
              <Alert>
                ...
                <AlertDescription>
                  Обработано строк:{" "}
                  {uploadStatus?.rowsSuccessful || uploadResponse?.rowsSuccessful || 0}
            ...
            {selectedFile && (
              <div className="text-sm text-muted-foreground">
                ...
                <span className="font-medium text-foreground">
                  {targetTable === "balance" ? "Баланс" : "Финрез"}
                </span>
              </div>
            )}
            <div className="flex gap-2">
              ...
              >
                {isLoading
                  ? "Загрузка..."
                  : `Загрузить в ${targetTable === "balance" ? "Баланс" : "Финрез"}`}
              </Button>
