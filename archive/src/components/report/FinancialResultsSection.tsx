...
import { TrendingUpIcon, PercentIcon, ActivityIcon, WalletIcon, BanknoteIcon } from "lucide-react";
...
const kpiMetrics = [
  {
    ...
    value: "₽6.5B",
    description:
      "Финансовый результат после всех расходов, резервов и налогов. Базовый индикатор прибыльности банка.",
    change: 14.2,
    ytdChange: 18.5,
  ...
  },
  {
    ...
    value: "₽2.1B",
    description:
      "Операционная прибыль до вычета процентов, налогов, износа и амортизации. Показывает операционную эффективность без влияния резервов.",
    change: 12.3,
    ytdChange: 8.4,
  ...
  },
  {
    ...
    value: "42.5%",
    description:
      "Отношение операционных расходов к операционным доходам. Главный показатель эффективности затрат для сравнения по времени и с конкурентами.",
    change: -3.1,
    ytdChange: -5.2,
  ...
  },
  {
    ...
    value: "2.8%",
    description:
      "Return on Assets — отношение чистой прибыли к средним активам. Показывает, насколько эффективно банк использует активы.",
    change: 0.4,
    ytdChange: 1.2,
  ...
  },
  {
    ...
    value: "18.2%",
    description:
      "Return on Equity — отношение чистой прибыли к собственному капиталу. Показывает, сколько зарабатывает капитал собственников.",
    change: 2.1,
    ytdChange: -0.3,
...
const defaultIncomeData: TableRowData[] = [
  {
    id: "i1",
    name: "Чистый процентный доход (ЧПД)",
    value: 3200000000,
    isGroup: true,
    description: "Разница между процентными доходами и расходами",
    change: 5.2,
    changeYtd: 8.1,
  },
  {
  ...
  {
    id: "i3-3",
    name: "Прочие процентные расходы",
    value: -100000000,
    percentage: 11.1,
    parentId: "i3",
    change: 4.1,
  ...
  {
    id: "i4",
    name: "Чистый комиссионный доход (ЧКД)",
    value: 5800000000,
    isGroup: true,
    description: "Доходы от комиссий за услуги банка",
    change: 12.3,
    changeYtd: 15.8,
  },
  {
    id: "i5",
    name: "Комиссии международных переводов",
    value: 3200000000,
    isGroup: true,
    parentId: "i4",
    change: 15.1,
  ...
  },
  {
    ...
    value: 2400000000,
    isGroup: true,
    description: "Доходы от валютно-обменных операций",
    change: 9.8,
    changeYtd: 12.5,
  },
  {
    id: "i9",
    name: "Спред конвертаций",
    value: 1400000000,
    isGroup: true,
    parentId: "i8",
    description: "Доход от разницы курсов покупки и продажи валюты",
    change: 11.2,
    changeYtd: 14.1,
  },
  {
...
const expensesData: TableRowData[] = [
  {
    ...
    value: 2800000000,
    isGroup: true,
    description: "Фонд оплаты труда: зарплаты и обязательные взносы",
    change: 6.5,
    changeYtd: 9.2,
  },
  {
  ...
  },
  {
    ...
    value: 2300000000,
    isGroup: true,
    description: "Операционные и административные расходы",
    change: 2.8,
    changeYtd: 4.2,
  },
  {
  ...
  },
  {
    ...
    isGroup: true,
    parentId: "e4",
    description: "Расходы на обработку транзакций",
    change: 5.3,
    changeYtd: 7.8,
  },
  {
    id: "e6-1",
    name: "Карточный процессинг",
    value: 408000000,
    percentage: 60.0,
    parentId: "e6",
    change: 5.8,
  ...
  },
  {
    ...
    value: 400000000,
    isGroup: true,
    description: "Изменение резервов на возможные потери",
    change: -8.5,
    changeYtd: -12.2,
  },
  {
    id: "e11",
    name: "Создание резервов",
    value: 650000000,
    isGroup: true,
    parentId: "e10",
    change: -5.2,
...
const expensesGroupingOptions: GroupingOption[] = [{ id: "fot", label: "ФОТ" }];
